...
url="https://hiskenya.org/api/26/analytics.json?dimension=ou:LEVEL-5;HfVjCurKxh2&dimension=dx:NYkr7LlxmUg;qw7eJpLE3vK;dlldM4hP2Wk;NOga2tabGrd&dimension=pe:"
...
clean_df<-clean_df %>% select(County,SubCounty,Ward,Facility,khisId,MFLCode,ReportPeriod,TotalLinked,
                              NegativeTotal,PositiveTotal,TestedTotal)
