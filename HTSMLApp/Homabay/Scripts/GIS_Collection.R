...
# Filter to facilities in Homa Bay and keep facility name, longitude and latitude
...
# Get extent of Homa Bay to crop subsequent geospatial files
range(facilities$Longitude)
range(facilities$Latitude)
e <- extent(33, 36, -1, 0) 
...
gar <- crop(gar, e)
# gar_raster <- rasterize(gartest, DEM)
...
saveRDS(facilities, './facilities_homabay_3km_20210519.rds')
